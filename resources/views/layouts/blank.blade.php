...
<body>
<section style="margin: 40px auto;max-width: 1100px; background-image: url('{{asset('public/assets/installation/assets/img/page-bg.png')}}')"
         class="w-100 min-vh-100 bg-img position-relative py-5">

    <div class="custom logo">
        <a href="https://cleaningerp.click/">
            <img style="max-width: 250px;" src="{{asset('public/images/logo.png')}}" alt="{{ translate('favicon') }}">
        </a>
    </div>

    <div class="custom-container" style="margin: 20px;">
        @yield('content')
    ...
    <footer class="footer py-3 mt-4">
            <div class="d-flex flex-column flex-sm-row justify-content-between gap-2 align-items-center">
                <div class="footer-logo">
                    <img style="max-width: 250px;" src="{{asset('public/images/logo.png')}}" alt="{{ translate('logo') }}">
                </div>
                <p style=" margin: 10px;" class="copyright-text mb-0">© {{ translate('2024 | All Rights Reserved') }}</p>
            </div>
        </footer>
</section>
</body>
