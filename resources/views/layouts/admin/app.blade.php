...
@if(Auth::guard('web')->user()->user_type == 3)
    @include('layouts.admin.partials._sidebar')
@elseif(Auth::guard('web')->user()->user_type == 4)
    @include('layouts.admin.partials.admin_sidebar')
@else
    @include('layouts.admin.partials.employee_sidebar')
@endif
                    ...
                    success: function (response) {
                        ...
                        response.users.forEach(user => {
                            $('#search-results').append(`
                                <li class="list-group-item"><a  href="{{route('admin.customer.view')}}/${user.id}">${user.name} - ${user.phone}</a></li>
                            `);
                        });
                        response.users_by_visit.forEach(visit => {
                            $('#search-results').append(`
                                <li class="list-group-item"><a  href="{{route('admin.order.view')}}/${visit.id}">${visit.custom_id}</a></li>
                            `);
                        });
                        $('#search-results').show();
                    },
