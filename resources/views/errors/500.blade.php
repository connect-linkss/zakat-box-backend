...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('public/images/ecommerce/' . $icon ?? '') }}">
...
<div class="footer text-center">
    <ul class="list-inline list-separator">
        <li class="list-inline-item">
            <a class="list-separator-link" target="_blank" href="<?php echo url('/') ?>">{{ \app\CentralLogics\Helpers::get_business_settings('restaurant_name') }} {{ translate('Support') }}</a>
